    ...
    lut.m_keywordsByDrawer = {
        ...
        {QStringLiteral("🎨 設計與影音剪輯"),
         {QStringLiteral("素材"), QStringLiteral("設計"), QStringLiteral("design"), QStringLiteral("figma"),
          QStringLiteral("psd"), QStringLiteral("ai"), QStringLiteral("pr"), QStringLiteral("ae"),
          QStringLiteral("字體"), QStringLiteral("font"), QStringLiteral("logo"), QStringLiteral("mockup"),
          QStringLiteral("uiux"), QStringLiteral("剪輯"), QStringLiteral("劇本"), QStringLiteral("storyboard"),
          QStringLiteral("音效")}},
        ...
        {QStringLiteral("🗄️ 數據與財務報表"),
         {QStringLiteral("sql"), QStringLiteral("db"), QStringLiteral("xlsx"), QStringLiteral("csv"),
          QStringLiteral("統計"), QStringLiteral("財報"), QStringLiteral("excel"), QStringLiteral("xls"),
          QStringLiteral("spreadsheet"), QStringLiteral("database"), QStringLiteral("query"), QStringLiteral("chart"),
          QStringLiteral("分析"), QStringLiteral("analysis"), QStringLiteral("樞紐"), QStringLiteral("dashboard"),
          QStringLiteral("xml"), QStringLiteral("json")}},
...
QString SfDrawerCategoryLut::normalizeDrawerKey(const QString &raw) const
{
    ...
    static const QMap<QString, QString> kLegacyToCanon = {
        ...
        {QStringLiteral("💰 財務"), QStringLiteral("🗄️ 數據與財務報表")},
        {QStringLiteral("💰 財務帳務"), QStringLiteral("🗄️ 數據與財務報表")},
        ...
        {QStringLiteral("🗄️ 數據資料"), QStringLiteral("🗄️ 數據與財務報表")},
        {QStringLiteral("🗄️ 數據與報表"), QStringLiteral("🗄️ 數據與財務報表")},
